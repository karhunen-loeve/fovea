...
#      Commit acbecb7 deleted `## [0.3.0]` while adding an `### Added`
#      block, folding every released 0.3.0 entry back into `[Unreleased]`.
#
#   2. A retroactive edit to a shipped entry. Later work rewrote two 0.3.0
#      entries in place to describe post-release behaviour, which also
#      hid a breaking change that was never listed under `[Unreleased]`.
#
